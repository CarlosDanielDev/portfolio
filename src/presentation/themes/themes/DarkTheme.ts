...
export function createDarkTheme(): Theme {
  const tokens: ThemeTokens = {
    colors: {
      ...
      text: {
        primary: new Color('#f8f9fa'),
        secondary: new Color('#adb5bd')
      },
    ...
    shadows: {
      ...
      medium: '0 4px 6px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.5)',
      large: '0 10px 20px rgba(0,0,0,0.6), 0 3px 6px rgba(0,0,0,0.5)'
    },
    breakpoints: {
